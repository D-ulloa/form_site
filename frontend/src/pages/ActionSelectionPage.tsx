    ...
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        ...
        <div className="w-full max-w-lg animate-fade-in-up delay-100">
          ...
          <button
            type="button"
            id="btn-manage-arrangements"
            onClick={() => navigate(`/t/${organizationContext.organization.slug}/arrangements`)}
            className="group mt-3 w-full surface rounded-2xl p-6 text-left transition-all duration-200 hover:border-indigo-500/40 hover:shadow-lg hover:shadow-indigo-500/10 hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-indigo-400 cursor-pointer"
          >
            <div className="flex items-center gap-5">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-indigo-500/15 text-indigo-300 transition-transform group-hover:scale-105">
                <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.75l3 3m-9 4.5L3.75 18.75a1.59 1.59 0 002.25 2.25l4.5-4.5M14.25 6.75a5.25 5.25 0 00-6 6L12 16.5a5.25 5.25 0 006-6l-3 3-4.5-4.5 3-3z" />
                </svg>
              </div>
              <div className="min-w-0 flex-1">
              ...
              <svg className="h-5 w-5 shrink-0 text-slate-600 transition-all group-hover:translate-x-1 group-hover:text-indigo-400"
                fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            </div>
