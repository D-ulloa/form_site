...
Saved contract JSON contains bucket/path metadata, not a public URL or an expiring download URL. The bucket must remain private; serving DNI images later requires a separately authorized signed-download endpoint.
