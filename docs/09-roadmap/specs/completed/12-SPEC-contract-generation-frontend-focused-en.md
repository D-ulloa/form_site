...
- Focused coverage lives in `backend/tests/unit/contract-entries-spec12.test.ts`, `frontend/tests/integration/ContractFormPage.test.tsx`, `frontend/tests/integration/ContractEntryModal.test.tsx`, and `frontend/tests/unit/ContractRepeatableSection.test.tsx`.
