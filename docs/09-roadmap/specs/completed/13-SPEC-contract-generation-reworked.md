...
- Focused coverage lives in `backend/tests/integration/contract-entries-spec13.test.ts`, `frontend/tests/integration/ContractFormPage.test.tsx`, `frontend/tests/integration/ContractEntryModal.test.tsx`, and `frontend/tests/unit/ContractInspectionDetails.test.tsx`.
