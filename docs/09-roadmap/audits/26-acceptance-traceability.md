...
| 17–18 invitation lifecycle/no owner invite | invitation schema/RPC, tokens, fake delivery | Unit/migration tests | Resend/revoke activation waits for SPEC-27 |
...
| 29–30 API context/isolation | protected routes deliberately unmounted | Legacy regression suite | SPEC-27 activation pending |
