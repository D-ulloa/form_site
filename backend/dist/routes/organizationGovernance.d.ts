 ...
 */
export declare function createOrganizationGovernanceRouter(resolver: OrganizationRouteContextResolver, services: OrganizationRouteServices, publicBaseUrl: string): Router;
