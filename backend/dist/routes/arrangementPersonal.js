...
export function createArrangementPersonalRouter(sessions, environment, dependencies) {
    const router = Router({ mergeParams: true });
    const security = createTenantMutationSecurity(sessions, environment);
    for (const operation of ['create', 'rotate', 'revoke']) {
...
//# sourceMappingURL=arrangementPersonal.js.map