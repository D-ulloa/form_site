export declare const MIGRATION_MODES: readonly ["dry_run", "rehearsal", "production", "validation", "rollback"];
export type MigrationMode = typeof MIGRATION_MODES[number];
export declare const FEATURE_STATES: readonly ["disabled", "certified_enabled"];
...
export type InventoryDisposition = 'migrate_to_azar' | 'retain_scoped' | 'quarantine' | 'exclude_non_business' | 'delete_after_approval';
