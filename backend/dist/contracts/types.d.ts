export type ContractFieldType = 'string' | 'email' | 'number' | 'date' | 'boolean' | 'select';
...
export type ContractEvidenceFileField = 'recibo_sueldo_files' | 'garantia_propietaria_files';
...
export type ContractValidationIssueCode = 'invalid_request' | 'unknown_schema' | 'contract_type_mismatch' | 'required' | 'unknown_field' | 'invalid_type' | 'invalid_email' | 'invalid_date' | 'min' | 'max' | 'max_length' | 'pattern' | 'invalid_option' | 'invalid_schema';
