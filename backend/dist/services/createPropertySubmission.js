 ...
 */
export async function createPropertySubmission(payload, files) {
    // ── Step 2: Generate IDs ───────────────────────────────────────────────────
    ...
    try {
        ...
        await persistSubmissionLog(buildLog({ property_id, submission_id, created_at, outcome: 'failure', steps, error }));
