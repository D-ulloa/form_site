...
function assertNoSecretKeys(value) {
    ...
    for (const [key, child] of Object.entries(value)) {
        if (SECRET_KEY.test(key))
            throw new OrganizationProvisioningError('SECRET_MATERIAL_FORBIDDEN');
...
export function parseOrganizationProvisioningManifest(contents) {
...
//# sourceMappingURL=organizationProvisioningManifest.js.map