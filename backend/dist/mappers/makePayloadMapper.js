 ...
 */
export function buildMakePayload(args) {
    const { property_id, submission_id, created_at, payload, folder_name, folder_url, parent_folder_id, media_files, total_size_bytes, } = args;
...
//# sourceMappingURL=makePayloadMapper.js.map