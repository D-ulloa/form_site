...
export function createOrderCursorCodec(secret) {
    ...
    const bindingKey = (binding) => JSON.stringify(['arrangements.orders', 1, binding.organization_id, binding.status, binding.limit, 'id.asc']);
    return {
        encode(afterId, binding) {
...
//# sourceMappingURL=orderCursor.js.map