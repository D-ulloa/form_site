...
export type SelfServiceOnboardingState = 'started' | 'identity_created' | 'organization_created'
  | 'completed' | 'failed_recoverable' | 'rejected';
...
export type SelfServiceOnboardingErrorCode =
...
export class SelfServiceOnboardingError extends Error {
  ...
  constructor(readonly code: SelfServiceOnboardingErrorCode) {
    super(code);
